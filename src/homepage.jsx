...
const HomePage = () => {
  useEffect(() => {
    ...
    const handleScroll = () => {
      AOS.refresh(); // Refresh AOS to trigger animations on scroll
    };
  ...
  return (
    <div
      ...
      style={{
        ...
        minHeight: '100vh', // Ensures the page has enough height to scroll
      }}
    >
        ...
        <div className="flex flex-1 justify-center py-5">
          <div className="flex flex-col flex-1">
            <div className="flex flex-col md:flex-row items-center p-4">
              <div className="flex w-full flex-col-1 md:flex-rows gap-4 items-center" data-aos="fade-up">
                <img src={pfp} alt="Example" className="size-32 md:size-64 rounded-full" />
              ...
              <div className="flex w-full max-w-[720px] gap-3 @[480px]:w-auto mt-5" data-aos="fade-up" data-aos-delay="200">
                <p className="text-white">
                  My name is Allen Paul Rebolla, a front-end developer based in Gumaca, Quezon, Philippines. I have worked on a wide range
                  of front-end projects, from delivery applications to web management system, with a focus on creating clean, well-crafted
            ...
            {/* Experience Section */}
            <h3 className="text-white text-lg font-bold leading-tight tracking-[-0.015em] px-4 pb-2 pt-4 mt-10" data-aos="fade-up" data-aos-delay="600">
              Experience
            </h3>
